    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <div class="btn btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-cronjob-check">{{ __('Copy') }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <div class="btn btn-primary" data-enable="tooltip-copy" title="{{ __('Copy') }}" data-copy="{{ __('Copy') }}" data-copied="{{ __('Copied') }}" data-clipboard-target="#i-cronjob-email">{{ __('Copy') }}</div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-sm d-flex text-truncate">
                                ...
                                @elseif($cronjob->name == 'check')
                                    <div class="badge badge-warning text-truncate">
                                        {{ $cronjob->name }}
                                    </div>
